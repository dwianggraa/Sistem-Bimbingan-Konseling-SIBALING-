                ...
                <ul>
                    ...
                    <li class="active open">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="active open"><a href="/perizinan" class="link"><span>Perizinan</span></a></li>
                        </ul>
            ...
            <div class="content-wrapper">
                <div class="row same-height">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <h3>Form Edit Data Perizinan</h3><br>
                                <div class="row">

                                    <div class="col-md-12">
                                        <form action="{{ url('perizinan/update', $perizinan->id) }}" method="POST">
                                            @csrf
                                            <div class="mb-2">
                                                ...
                                                <div class="input-group input-append date"
                                                    ...
                                                    <input name="tgl" id="tgl" class="form-control"
                                                        type="text" readonly="" autocomplete="off" value="{{ $perizinan->tgl }}">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input name="name" id="name" class="form-control"
                                                    ...
                                                    aria-label="default input example" value="{{ $perizinan->name }}">
                                            </div>
                                            <div class="mb-2">
                                                <label for="basicInput" class="form-label"> NIS (Nomor Induk Sekolah)</label>
                                                <input name="nis" id="nis" class="form-control"
                                                    type="text" placeholder="Masukkan NIS"
                                                    aria-label="default input example" value="{{ $perizinan->nis }}">
                                            </div>
                                            <div class="mb-2">
                                                <label for="basicInput" class="form-label"> Kelas</label>
                                                <select id="kelas" 
                                                    name="kelas"class="js-example-basic-single form-select"value="{{ $perizinan->kelas }}">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select id="jurusan" name="jurusan"
                                                    class="js-example-basic-single form-select" value="{{$perizinan->jurusan }}">
                                            ...
                                            <div class="mb-2">
                                                <label for="basicInput" class="form-label"> Jenis Perizinan</label>
                                                <select id="jenis" name="jenis" 
                                                    class="js-example-basic-single form-select">
                                                    <option>Pilih jenis perizinan</option>
                                                    <option value="{{ $perizinan->jenis }}" data-perizinan="sakit">Sakit</option>
                                                    <option data-perizinan="alfa">Alfa</option>
                                                    <option data-perizinan="izin">Izin</option>
                                                </select>
                                                <script>
                                                    const jenis = $('#jenis').data('perizinan');
                                                    $('[name=jenis]').val(jenis);
                                                </script>
                                            </div>
                                            <div class="mb-2">
                                                <label for="basicInput" class="form-label"> Upload Surat Izin</label><br>
                                                <input type="file" class="form-control @error('suratizin') is-invalid @enderror" 
                                                name="suratizin" id="suratizin" value="{{ $perizinan->suratizin }}">
                                                @error('suratizin')
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Apakah anda yakin untuk mengubah data perizinan?
                                                        </div>
