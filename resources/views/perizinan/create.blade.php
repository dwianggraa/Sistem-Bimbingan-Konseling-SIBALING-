            ...
            <div class="content-wrapper">
                <div class="row same-height">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <h3>Form Tambah Data Perizinan</h3><br>
                                <div class="row">

                                    <div class="col-md-12">
                                        <form action="{{ url('perizinan/simpan') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="mb-2">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select id="jenis" name="jenis"
                                                    ...
                                                    <option data-perizinan="sakit">Sakit</option>
                                                    <option data-perizinan="alfa">Izin</option>
                                                    <option data-perizinan="izin">Alfa</option>
                                                </select>
                                                <script>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input type="file" class="form-control @error('suratizin') is-invalid @enderror" name="suratizin" id="suratizin">
                                                @error('suratizin')
