                ...
                <ul>
                    ...
                    <li class="active open">
                        ...
                        <ul class="sub-menu ">
                            ...
                            <li class="active open"><a href="/kesehatan" class="link"><span>Kesehatan Mental</span></a></li>
            ...
            <div class="content-wrapper">
                <div class="row same-height">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <h3>Form Edit Data kesehatan</h3><br>
                                <div class="row">

                                    <div class="col-md-12">
                                        <form action="{{ url('kesehatan/update', $kesehatan->id) }}" method="POST">
                                            @csrf
                                            <form action="{{ url('kesehatan/simpan') }}" method="POST">
                                                @csrf
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group input-append date"
                                                        ...
                                                        <input name="tgl" id="tgl" class="form-control"
                                                            type="text" readonly="" autocomplete="off" value="{{$kesehatan->tgl }}">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input name="judul" id="judul" class="form-control"
                                                        type="text" placeholder="Masukkan judul kesehatan"
                                                        aria-label="default input example" value="{{$kesehatan->judul }}">>
                                                </div>
                                                <div class="mb-2">
                                                    <label for="basicInput" class="form-label"> Deskripsi</label>
                                                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3">value="{{$kesehatan->deskripsi }}"></textarea>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Apakah anda yakin untuk mengubah data kesehatan?
                                                        </div>
