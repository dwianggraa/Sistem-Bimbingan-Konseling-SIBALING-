                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Data Konten Kesehatan Mental</h4>
                                </div>

                                <div class="card-body">
                                    <div class="d-grid gap-4 d-lg-flex justify-content-lg-end">
                                        <a href="/kesehatan/create" class="btn btn-primary"> Tambah
                                            Data </a>

                                    </div>

                                    <br>
                                    <form action="/anbk" method="GET">
                                                ...
                                                @foreach ($kesehatan as $key => $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <li class="list-inline-item">
                                                                <a href="{{ url('/anbk/delete', $item->id) }}"
