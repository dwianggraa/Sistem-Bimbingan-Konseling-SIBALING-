            ...
            <div class="content-wrapper">
                <div class="row same-height">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <h3>Form Edit Data Pelanggaran</h3><br>
                                <div class="row">

                                    <div class="col-md-12">
                                        <form action="{{ url('pelanggaran/update', $pelanggaran->id) }}" method="POST">
                                            @csrf
                                            <div class="mb-2">
                                                ...
                                                <div class="input-group input-append date"
                                                    ...
                                                    <input name="tgl" id="tgl" class="form-control"
                                                        type="text" readonly="" autocomplete="off" value="{{ $pelanggaran->tgl }}">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input name="name" id="name" class="form-control"
                                                    ...
                                                    aria-label="default input example" value="{{ $pelanggaran->name }}">
                                            </div>
                                            <div class="mb-2">
                                                ...
                                                <input name="nis" id="nis" class="form-control"
                                                    ...
                                                    aria-label="default input example" value="{{ $pelanggaran->nis }}">
                                            </div>
                                            <div class="mb-2">
                                                <label for="basicInput" class="form-label"> Kelas</label>
                                                <select id="kelas" 
                                                    name="kelas"class="js-example-basic-single form-select"value="{{ $pelanggaran->kelas }}">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select id="jurusan" name="jurusan"
                                                    class="js-example-basic-single form-select" value="{{$pelanggaran->jurusan }}">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select id="jenis" name="jenis" 
                                                    ...
                                                    <option value="{{ $pelanggaran->jenis }}" data-pelanggaran="ringan">Ringan (2 - 20 poin)</option>
                                            ...
                                            <div class="mb-2">
                                                <label for="basicInput" class="form-label"> Deskripsi
                                                    Pelanggaran</label>
                                                <textarea class="form-control" id="deskripsi" name="deskripsi"  rows="3">{{ $pelanggaran->deskripsi }}</textarea>
                                            </div>
                                            <div class="mb-2">
                                                <label for="basicInput" class="form-label"> Poin</label>
                                                <input id="jumlahpoin" name="jumlahpoin" class="form-control"
                                                    type="number" placeholder="Masukkan jumlah poin"
                                                    aria-label="default input example" value="{{ $pelanggaran->jumlahpoin }}">
                                            </div><br>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Apakah anda yakin untuk mengubah data pelanggaran?
                                                        </div>
