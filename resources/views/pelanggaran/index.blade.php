                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-grid gap-4 d-lg-flex justify-content-lg-end">
                                        <a href="/pelanggaran/create" class="btn btn-primary"> Tambah
                                            Data </a>
                                        ...
                                        <table class="table" id="example" class="display nowrap">
                                            ...
                                            <tbody>
                                                @foreach ($pelanggaran as $key => $item)
                                                    <tr>
                                                        <td>{{ $pelanggaran->firstItem() + $key }}</td>
                                                        <td>{{ $item['nis'] }}</td>
                                                        <td>{{ $item['name'] }}</td>
                                                        <td>{{ $item['jurusan'] }}</td>
                                                        <td>{{ $item['kelas'] }}</td>
                                                        ...
                                                        <td>{{ $item['jumlahpoin'] }}</td>
                                                        <td>{{ $item['tgl'] }}</td>
                                                        <td>
                                                    
                                                            <li class="list-inline-item">
                                                                <a href="{{ url('/pelanggaran/edit', $item->id) }}"
                                                            ...
                                                            <li class="list-inline-item">
                                                                <a href="{{ url('/pelanggaran/delete', $item->id) }}"
