                ...
                <div class="card shadow-lg">
                        ...
                        <form action="/login-admin" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-join mb-3">
                                    <input id="username" type="username" placeholder="Masukkan username" class="form-control
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-join mb-3">
                                    ...
                                    @error('password') is-invalid @enderror" placeholder="Masukkan password" required>
                    ...
                    <div class="card-footer py-3 border-0">
                        <div class="text-center">
                            Masuk sebagai siswa? <a href="/login-siswa" class="text-dark">Klik disini
                        </div>
                    </div>
                </div>
