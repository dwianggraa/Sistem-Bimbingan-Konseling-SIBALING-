                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <form action="{{ url('pelanggaran/update', $peg->id) }}" method="POST">
                                            @csrf
                                            <div class="mb-2">
                                                ...
                                                <div class="input-group input-append date"
                                                    ...
                                                    <input name="tgl" id="tgl" class="form-control"
                                                        type="text" readonly="" autocomplete="off" value="{{ $peg->tgl }}">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input name="name" id="name" class="form-control"
                                                    ...
                                                    aria-label="default input example" value="{{ $peg->name }}">
                                            </div>
                                            <div class="mb-2">
                                                ...
                                                <input name="nis" id="nis" class="form-control"
                                                    ...
                                                    aria-label="default input example" value="{{ $peg->nis }}">
                                            </div>
                                            <div class="mb-2">
                                                <label for="basicInput" class="form-label"> Kelas</label>
                                                <select id="kelas" 
                                                    name="kelas"class="js-example-basic-single form-select"value="{{ $peg->kelas }}">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select id="jurusan" name="jurusan"
                                                    class="js-example-basic-single form-select" value="{{$peg->jurusan }}">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select id="jenis" name="jenis" 
                                                    ...
                                                    <option value="{{ $peg->jenis }}" data-pelanggaran="ringan">Ringan (2 - 20 poin)</option>
                                            ...
                                            <div class="mb-2">
                                                <label for="basicInput" class="form-label"> Deskripsi
                                                    Pelanggaran</label>
                                                <textarea class="form-control" id="deskripsi" name="deskripsi"  rows="3">{{ $peg->deskripsi }}</textarea>
                                            </div>
                                            <div class="mb-2">
                                                ...
                                                <input id="jumlahpoin" name="jumlahpoin" class="form-control"
                                                    ...
                                                    aria-label="default input example" value="{{ $peg->jumlahpoin }}">
                                            </div><br>
