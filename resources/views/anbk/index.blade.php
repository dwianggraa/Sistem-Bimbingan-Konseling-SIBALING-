            ...
            <div class="sidebar-content">
                <ul>
                    ...
                    <li class="active open">
                        ...
                        <ul class="sub-menu ">
                            <li class="active open"><a href="/anbk" class="link"><span>ANBK</span></a></li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Data Informasi anbk</h4>
                                </div>

                                <div class="card-body">
                                    <div class="d-grid gap-4 d-lg-flex justify-content-lg-end">
                                        <a href="/anbk/create" class="btn btn-primary"> Tambah
                                            Data </a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="example" class="display nowrap">
                                            ...
                                            <tbody>
                                                @foreach ($anbk as $key => $item)
                                                    <tr>
                                                        <td>{{ $anbk->firstItem() + $key }}</td>
                                                        <td>{{ $item['judul'] }}</td>
