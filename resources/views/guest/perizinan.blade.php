                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Data Perizinan Siswa</h4><br>
                                </div>

                                <div class="card-body">
                                    <div class="d-grid gap-4 d-lg-flex justify-content-lg-end">
                                        <a href="/perizinan/create" class="btn btn-primary"> Tambah
                                            Data </a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="example" class="display nowrap">
                                            ...
                                            <tbody>
                                                @foreach ($perizinan as $key => $item)
                                                <tr>
                                                        <td>{{$perizinan->firstItem() + $key }}</td>
                                                        <td>{{ $item['nis'] }}</td>
                                                        <td>{{ $item['name'] }}</td>
                                                        <td>{{ $item['jurusan'] }}</td>
                                                        <td>{{ $item['kelas'] }}</td>
                                                        <td>{{ $item['jenis'] }}</td>
                                                        <td>
                                                            <a href="storage/{{$item->suratizin}}"><button type="button"
                                                                class="btn btn-primary">Lihat File</button>
                                                        </td>
                                                        <td>{{ $item['tgl'] }}</td>
                                                        <td>
                                                            <li class="list-inline-item">
                                                                <a href="/perizinan/view"
                                                            ...
                                                            <li class="list-inline-item">
                                                                <a href="{{ url('/perizinan/edit', $item->id) }}"
                                                            ...
                                                            <li class="list-inline-item">
                                                                <a href="{{ url('/perizinan/delete', $item->id) }}"
