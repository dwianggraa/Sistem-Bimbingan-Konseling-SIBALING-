    ...
    <div id="app">
        ...
        <nav class="main-sidebar ps-menu">
            ...
            <div class="sidebar-content">
                <ul>
                    <li class="active">
                        <a href="/dashboard-guest" class="link">
                            <i class="ti-home"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                    <li>
                        ...
                        <ul class="sub-menu ">
                            <li><a href="/pelanggaran-guest" class="link"><span>Pelanggaran</span></a></li>
                            <li><a href="/perizinan-guest" class="link"><span>Perizinan</span></a></li>
                        </ul>
