...
<body>
        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#about">Layanan Konseling</a></li>
                    <li><a class="nav-link scrollto" href="#services">Mental health</a></li>
                    <li><a class="nav-link scrollto" href="#team">Beasiswa</a></li>
                    <li><a class="nav-link scrollto " href="#portfolio">ANBK</a></li>
                    @auth
                        <li class="dropdown"><a href="#"><span>
                                    Welcome, {{ auth()->user()->username }} </span> <i class="bi bi-chevron-down"></i></a>
                            <ul>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1>Selamat Datang di <span>Sibaling</span></h1>
            <h2></h2>
            <div class="d-flex">
            </div>
        </div>
    ...
    <main id="main">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <p class="description">Akan tersedia informasi terkini dari kesehatan mental</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <h4 class="title"><a href="">Beasiswa</a></h4>
                            <p class="description">Akan tersedia informasi beasiswa terbaru dalam negeri dan luar
                                negeril</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <h4 class="title"><a href="">Layanan Konseling</a></h4>
                            <p class="description">Form Pendaftaran Konseling Secara Offline</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <h4 class="title"><a href="">ANBK</a></h4>
                            <p class="description">Tersedia informasi terbaru dari ANBK 2022/2023</p>
                        </div>
                    </div>
        ...
        <section id="about" class="about section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    ...
                    <h3>Punya permasalahan ? <span> Curhat disini</span></h3>
                    <p>Layanan ini akan diteruskan kepada pihak Bimbingan Konseling, kerahasiaan terjamin</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center"
                        ...
                        <form action="/layanan/simpan" method="POST">
                            <div class="mb-2">
                                <label for="basicInput" class="form-label"> Nama Siswa</label>
                                <input name="name" id="name" class="form-control" type="text"
                                    placeholder="Masukkan nama siswa" aria-label="default input example">
                            </div>
                            <div class="mb-2">
                                <label for="basicInput" class="form-label"> NIS (Nomor Induk
                                    Sekolah)</label>
                                <input name="nis" id="nis" class="form-control" type="text"
                                    placeholder="Masukkan NIS" aria-label="default input example">
                            </div>
                            <div class="mb-2">
                                <label for="basicInput" class="form-label"> Kelas</label>
                                <select id="kelas" name="kelas"class="js-example-basic-single form-select">
                            ...
                            <div class="mb-2">
                                ...
                                <select id="jurusan" name="jurusan" class="js-example-basic-single form-select">
        ...
        <section id="services" class="services">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Mental Health</h2>
                    <h3>Apa Itu Kesehatan Mental & Pentingnya Kesehatan Mental</h3>
                    <p>Generasi milenial saat ini sudah banyak yang memperhatikan tentang kesehatan mental yang
                        dirasakan oleh setiap individu. Bahkan organisasi kesehatan dunia (WHO) sampai memberikan hari
                        kesehatan jiwa sedunia yang jatuh pada tanggal 10 Oktober. Dengan hari kesehatan jiwa yang
                        diberikan oleh WHO maka bisa dikatakan bahwa kesehatan mental mempunyai keistimewaan di mata
                        dunia.</p>
                </div>
