    ...
    <div id="app">
        ...
        <nav class="main-sidebar ps-menu">
            ...
            <div class="sidebar-content">
                <ul>
                    <li class="active">
                        <a href="/dasboard-admin" class="link">
                            <i class="ti-home"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu ">
                            <li><a href="/beasiswa" class="link">
                                    <span>Beasiswa</span></a>
                            </li>
                            <li><a href="/anbk" class="link">
                                    <span>ANBK</span></a>
                            </li>
                            <li><a href="/kesehatan" class="link">
                                    <span>Kesehatan Mental</span></a>
                            </li>
                            <li><a href="/layanan-konseling" class="link">
                                <span>Layanan Konseling</span></a>
                        </li>
                        </ul>
                    </li>
                </ul>
